...
$(document).ready(function() {
  ...
  var iconImage = 'https://github.com/ayushupneja/sonos-flow-player/raw/master/parker.jpg';

  AP.init({
    playList: [{
      'icon': iconImage,
      'title': 'Rygo - Off My Mind',
        'file': 'https://github.com/ayushupneja/sonos-flow-player/raw/master/rygo.mp3'
    }, {
      'icon': iconImage,
